Ext.define('Ext.ux.AGC-old', {
	extend: 'Ext.Component',
	alias: 'widget.agc-old',
	style: {
		height:'100%',
		width: '100%',
		'z-index': 100
       ...
       //   me = this;
           //      console.log("e :",e);
            ...
            qqt.executeForCount(qq, function(count){
              ...
              if (count < 1000) {
   //             mac.clear();
  //              tMSLayer.setVisibility(false);
              //  console.log('count < 1000, layer :',usaLayer);
...
//       var renderer = new esri.renderer.SimpleRenderer(dfsCoal)
 //      usaLayer.setRenderer(renderer);
//       usaLayer.setScaleRange(288895.277144, 36111.909643);

         	// mac.on("update-end", function(o) {
          //   console.log('AGC, mac features :',o.target.graphics.length);
          //   console.log('AGC, mac features o:',o);
         	// });
...
//        }
        if (evt.layer.id == 'points') {
          console.log('layer-add-result (mac), evt.layer.layerInfos :', evt.layer.layerInfos);
